...
public partial class @UserInput: IInputActionCollection2, IDisposable
{
    ...
    ~@UserInput()
    {
        Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, UserInput.Player.Disable() has not been called.");
        Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, UserInput.UI.Disable() has not been called.");
    }
